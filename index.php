...
<h1 class="title">Upload de Imagens e Videos</h1>

<section class="secao1" aria-labelledby="site-description">
    <header>
        <h2 class="title-description">Descrição do site</h2>
    </header>

    <p>Esse site permite que o usuário consiga fazer gerenciamento com facilidade de cliques.</p>
    <p>De maneira simples, gerenciar imagens e vídeos e até mesmo visualiza-los(as).</p>
</section>
